...
import { idlFactory } from './review_contract.did.js';
export { idlFactory } from './review_contract.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_REVIEW_CONTRACT;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./review_contract.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the review_contract canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./review_contract.did.js")._SERVICE>}
 */
export const review_contract = createActor(canisterId);
