...
import { idlFactory } from './review_assets.did.js';
export { idlFactory } from './review_assets.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_REVIEW_ASSETS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./review_assets.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the review_assets canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./review_assets.did.js")._SERVICE>}
 */
export const review_assets = createActor(canisterId);
